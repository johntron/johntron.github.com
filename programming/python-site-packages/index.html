...
<head>
  <meta charset="utf-8">
  <title>Python site-packages - Johntron.com</title>
  <meta name="author" content="John Syrinek">

  
  <meta name="description" content="To get the path of your Python site-packages, just type the following from the console: [bash]python -c “from distutils.sysconfig import &hellip;">
  ...
  <link rel="canonical" href="http://johntron.github.com/programming/python-site-packages/">
...
<article class="hentry" role="article">
  ...
  <header>
      ...
      <h1 class="entry-title">Python Site-packages</h1>
...
<div class="entry-content"><p>To get the path of your Python site-packages, just type the following from the console:</p>
...
<span class="categories">
  ...
  <a href="http://twitter.com/share" class="twitter-share-button" data-url="http://johntron.github.com/programming/python-site-packages/" data-via="johntron" data-counturl="http://johntron.github.com/programming/python-site-packages/" >Tweet</a>
    ...
    <p class="meta">
        ...
        <a class="basic-alignment left" href="/communication/measurability-and-metrics-are-king/" title="Previous Post: Measurability and Metrics are King">&laquo; Measurability and Metrics are King</a>
      
      
        <a class="basic-alignment right" href="/advice/sftp-svn-without-login/" title="Next Post: SSH-FTP &#038; Subversion without shell access">SSH-FTP &#038; Subversion without shell access &raquo;</a>
